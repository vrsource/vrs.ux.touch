...
onReady: function() {
   ...
   form_items = [
      {content: 'Item 1', leftIcon: 'checked.png', rightIcon: 'chevron.png'},
      {content: 'Item 1.5', leftIcon: 'checked.png', rightIcon: 'chevron.png'},
      {content: 'Just Right', rightIcon: 'chevron.png'},
